...
const BLOG_POSTS_INPUT: BlogPostInput[] = [
  {
    ...
    dateIso: "2026-06-10",
    readTime: "7 min",
    imageAlt: "Fleurs et compagnon animal — Fleurs de Bach pour animaux",
    inlineImageAlt: "Nature et fleurs, illustration bien-être animal",
    category: "article",
  ...
  },
  {
    ...
    dateIso: "2026-05-15",
    readTime: "7 min",
    imageAlt: "Chien détendu — séance Reiki pour animaux",
    inlineImageAlt: "Apaisement énergétique d'un compagnon à quatre pattes",
    category: "article",
    authorName: "Céline Belin, praticienne en soins énergétiques",
